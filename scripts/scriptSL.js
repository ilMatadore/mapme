...
function mapSingle() {
	...
	if (ul.childNodes.length < 14) {
	    var lat = document.createElement("li");
	    var labLat = document.createElement("label");
	    labLat.textContent = "Latitude"
	    var inpLat = document.createElement("p");
	    inpLat.setAttribute("id","inpLat");
	    inpLat.setAttribute("type", "text");
	    var spaLat = document.createElement("span");
	    spaLat.textContent = "Latitude";
	    lat.appendChild(labLat);
	    lat.appendChild(inpLat);
	    lat.appendChild(spaLat);
	    ul.insertBefore( lat,ul.childNodes[11]);

	    var lng = document.createElement("li");
	    var labLng = document.createElement("label");
	    labLng.textContent = "Longitude";
	    var inpLng = document.createElement("p");
		inpLng.setAttribute("id","inpLng");
	    inpLng.setAttribute("type", "text");
	    var spaLng = document.createElement("span");
	    spaLng.textContent = "Longitude";
	    lng.appendChild(labLng);
	    lng.appendChild(inpLng);
	    lng.appendChild(spaLng);
	    ul.insertBefore( lng,ul.childNodes[12]);
		};
