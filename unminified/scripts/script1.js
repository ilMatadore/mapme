...
singleLoc.click(); /*Loads initial map*/
L.mapquest.key = 'kj9G6HilbYNV3OLCyOgwEgi332xADIkN'; /*L.mapquest.key='fGlgbVLtBs7z2qOPTVrlcBg5qqpqQ5J3';*/
...
var btn = document.getElementById("help"); /* Get the <span> element that closes the modal */
